...
public class AvroIdlMapTypeImpl extends ASTWrapperPsiElement implements AvroIdlMapType {
  ...
  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof AvroIdlVisitor) ((AvroIdlVisitor)visitor).visitMapType(this);
