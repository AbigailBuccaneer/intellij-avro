...
FLOAT_LITERAL=-?(NaN|Infinity|({DECIMAL_FLOATING_POINT_LITERAL}))
DECIMAL_FLOATING_POINT_LITERAL={INT_LITERAL}(\.[:digit:]+)?([eE][+-]?[:digit:]+)?
STRING_LITERAL=\"([^\"]|\\\")*\"
LINE_COMMENT="//".*
DOC_COMMENT="/"\*\*([^*]|\*+[^/*])*\*+"/"
BLOCK_COMMENT="/"\*([^*]|\*+[^/*])*\*+"/"
...
<YYINITIAL> {
  ...
  {DECIMAL_FLOATING_POINT_LITERAL}      { return DECIMAL_FLOATING_POINT_LITERAL; }
